...
ActiveRecord::Schema.define(version: 202_012_111_533_081) do
  ...
  create_table 'case_suites', id: :integer, charset: 'utf8', force: :cascade do |t|
  ...
  create_table 'custom_commands', charset: 'utf8', force: :cascade do |t|
  ...
  create_table 'environments', id: :integer, charset: 'utf8', force: :cascade do |t|
    t.text 'url'
    t.string 'username'
    t.string 'password'
    t.datetime 'created_at'
  ...
  create_table 'result_cases', id: :integer, charset: 'utf8', force: :cascade do |t|
    t.integer 'rd_id'
    t.integer 'test_case_id'
  ...
  create_table 'result_suites', id: :integer, charset: 'utf8', force: :cascade do |t|
    t.integer 'rd_id'
    t.integer 'test_suite_id'
  ...
  create_table 'results_dictionaries', id: :integer, charset: 'utf8', force: :cascade do |t|
    t.text 'description'
    t.datetime 'created_at'
    t.datetime 'updated_at'
  end

  create_table 'schedulers', id: :integer, charset: 'utf8', force: :cascade do |t|
    t.integer 'test_suite_id'
  ...
  create_table 'suite_schedules', charset: 'utf8', force: :cascade do |t|
    t.integer 'test_suite_id'
    t.string 'name'
  ...
  create_table 'test_cases', id: :integer, charset: 'utf8', force: :cascade do |t|
    t.string 'field_name'
    t.string 'field_type'
  ...
  create_table 'test_suites', id: :integer, charset: 'utf8', force: :cascade do |t|
    t.string 'name'
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.integer 'environment_id'
