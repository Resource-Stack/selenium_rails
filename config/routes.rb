...
Rails.application.routes.draw do
  ...
  match '/home', to: 'welcome#home', via: %w[get post]
  ...
  match '/reports', to: 'environments#reports', via: %w[get post]

  match '/filter_reports', to: 'environments#filter_reports', via: %w[get post]
  ...
  match 'test_suites(/:id)/unschedule', to: 'test_suites#unschedule', via: %i[get post]
  ...
  post '/update_custom_command' => 'environments#update_custom_command'
